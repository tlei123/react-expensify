...
export const Login = (props) => (
  <div className="login component">
    ...
    <div className="login-btns">
      <button className="login-btn button third-party google" onClick={props.startLoginGoogle} title="Log in with Google">Login with Google</button>
          <button className="login-btn button third-party facebook" onClick={props.startLoginFacebook} title="Log in with Facebook">Continue with Facebook</button>
      <button className="login-btn button third-party twitter" onClick={props.startLoginTwitter} title="Log in with Twitter">Login with Twitter</button>
      <button className="login-btn button third-party github" onClick={props.startLoginGithub} title="Log in with GitHub">Login with GitHub</button>
  </div>
