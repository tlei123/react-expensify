...
import { startLoginGoogle, startLoginFacebook, startLoginTwitter } from '../actions/authActions';
...
export const Login = (props) => (
  <div className="login component">
    ...
    <button className="login-btn btn third-party twitter" onClick={props.startLoginTwitter} title="Log in with Twitter"></button>
