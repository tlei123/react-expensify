...
describe('expenseActions', () => {
  ...
  it('Should fetch db expenses correctly', (done) => {
  ...
  it('Should set up SET_EXPENSES action object with data', () => {
  ...
  it('Should add expense with defaults to database', (done) => {
    const store = createMockStore(defaultAuthState),
      expenseDefaults = {
        description: '',
        amount: 0,
  ...
  it('Should edit expense in database properly', (done) => {
    const store = createMockStore(defaultAuthState),
