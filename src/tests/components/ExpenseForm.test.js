...
describe('ExpenseForm component', () => {
  ...
  it('Should render error on invalid submission', () => {
    const wrapper = shallow(<ExpenseForm />);
  ...
  it('Should set amount state on valid input-change', () => {
  ...
  it('Should not set amount state on invalid input-change', () => {
  ...
  it('Should call onSubmit prop on valid submission', () => {
  ...
  it('Should set createdAt state on datepicker-change', () => {
    const wrapper = shallow(<ExpenseForm />),
      now = moment();
  ...
  it('Should set calendarFocused state on datepicker-focus', () => {
    const wrapper = shallow(<ExpenseForm />);
